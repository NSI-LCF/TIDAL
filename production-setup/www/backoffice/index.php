...
<body id="reportsPage">
    <div class="" id="home">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-5 mb-5">Bonjour <b><?php echo htmlspecialchars($User->username) ?></b></p>
                </div>
            </div>
            <!-- row -->
            <div class="row tm-content-row">
                <!-- Non finished Statistics part
    ...
    <!-- Non Finished Statistics Scripts
    <script>
