...
-- Listage de la structure de la base pour tidal-prod
CREATE DATABASE IF NOT EXISTS `tidal-prod` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `tidal-prod`;

-- Listage de la structure de la table tidal-prod. absences
...
-- Listage des données de la table tidal-prod.absences : ~0 rows (environ)
DELETE FROM `absences`;
/*!40000 ALTER TABLE `absences` DISABLE KEYS */;
/*!40000 ALTER TABLE `absences` ENABLE KEYS */;

-- Listage de la structure de la table tidal-prod. annonces
...
-- Listage des données de la table tidal-prod.annonces : ~0 rows (environ)
DELETE FROM `annonces`;
/*!40000 ALTER TABLE `annonces` DISABLE KEYS */;
/*!40000 ALTER TABLE `annonces` ENABLE KEYS */;

-- Listage de la structure de la table tidal-prod. cantine
...
-- Listage des données de la table tidal-prod.cantine : ~38 rows (environ)
DELETE FROM `cantine`;
...
-- Listage de la structure de la table tidal-prod. semaines
...
-- Listage des données de la table tidal-prod.semaines : ~52 rows (environ)
...
-- Listage de la structure de la table tidal-prod. users
...
-- Listage des données de la table tidal-prod.users : ~2 rows (environ)
DELETE FROM `users`;
